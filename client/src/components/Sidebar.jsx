...
import { SettingsOutlined, ChevronLeft, ChevronRightOutlined, HomeOutlined, ShoppingCartOutlined, Groups2Outlined, PublicOutlined, PointOfSaleOutlined, TodayOutlined, CalendarMonthOutlined, AdminPanelSettingsOutlined, TrendingUpOutlined, PieChartOutlineOutlined, ReceiptLongOutlined } from "@mui/icons-material"
...
const Sidebar = ({ user, drawerWidth, isSidebarOpen, setIsSidebarOpen, isNonMobile }) => {
    ...
    return (
        <Box component="nav">
            ...
            {isSidebarOpen && (
                <Drawer open={isSidebarOpen} variant="persistent"
